...
public class SemaphoreCollection {
    ...
    private static final Semaphore waitingArea = new Semaphore(Constant.getBusCapacity());
    ...
    private static final Semaphore busArrival = new Semaphore(Constant.getBusCountCanArrive());
